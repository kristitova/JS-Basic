...
function showMoreText(card) {
    ...
    let some_text = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Purus ut faucibus pulvinar elementum integer enim neque. Lorem ipsum dolor sit amet consectetur.';
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${some_text}</div>`)
